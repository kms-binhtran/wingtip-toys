...
public class NVPAPICaller
{
    ...
    public string APIUsername = "tranlebinh1988-facilitator_api1.gmail.com";
    private string APIPassword = "ZMKHWDNCKS89WS6W";
    private string APISignature = "An5ns1Kso7MWUdW4ErQKJJJ4qi4-AqHqYdfoib6Mue735R6OBgQlA5Sr";
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
        ...
        string returnURL = "https://localhost:5033/Checkout/CheckoutReview.aspx";
        string cancelURL = "https://localhost:5033/Checkout/CheckoutCancel.aspx";
